...
`, newState);
    ...
    class AppInstanceProposal {
        ...
        toAppInstanceFor(stateChannel) {
            return new AppInstance(stateChannel.getNextSigningKeys(), utils.bigNumberify(this.timeout).toNumber(), Object.assign({ addr: this.appDefinition }, this.abiEncodings), (this.intermediaries || []).length > 0, stateChannel.numInstalledApps, this.initialState, 0, utils.bigNumberify(this.timeout).toNumber(), "", undefined, undefined, undefined);
        }
        toJson() {
            return {
                identityHash: this.identityHash,
...
`;
    ...
    function merge(base, increments) {
        ...
        for (const key of Object.keys(increments)) {
            if (!base[key]) {
                throw new Error(`mismatch: ${Object.keys(increments)} ⊄ ${Object.keys(base)}`);
            }
        }
        return ret;
    }
    ...
    function getBalancesFromFreeBalanceAppInstance(freeBalanceAppInstance, tokenAddress) {
        ...
        const coinTransfers = freeBalanceState.balancesIndexedByToken[utils.getAddress(tokenAddress)] || [
